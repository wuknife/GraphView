...
class SugiyamaActivity : GraphActivity() {
    ...
    public override fun createGraph(): Graph {
        ...
        val node13 = Node(Label(nodeText))
        val node14 = Node(Label(nodeText))
        val node15 = Node(Label(nodeText))
        val node16 = Node(Label(nodeText))
        val node17 = Node(Label(nodeText))
        val node18 = Node(Label(nodeText))
        val node19 = Node(Label(nodeText))
        val node20 = Node(Label(nodeText))
        val node21 = Node(Label(nodeText))
        val node22 = Node(Label(nodeText))
        val node23 = Node(Label(nodeText))
